        ...
        private string GetEndOfReport5Sentences(string companyName, WordTypesEnum type, double? score)
        {
            ...
            if (score.HasValue == true) {
                ...
                switch (type)
                {
                    case WordTypesEnum.Talent:
                        if (range1)
                            result = $"{companyName} scores low in talent. Businesses that score low in talent tend to underinvest in people programs and are reactive to talent challenges. You likely have difficulty attracting and retaining the talent you need to win. We recommend that you take a more aggressive approach to ensuring that your employees have both the skills and commitment to deliver your business results. In the G3HC Best Practice Actionable Insights, there are 10 talent initiatives (such as acquiring talent, developing employees, encouraging diversity, and creating a positive employee experience) that you can choose from that have high impact on business outcomes.";
                        if (range2)
                            result = $"{companyName} scores moderately in talent. You are a solid choice, but not distinctive, for employees to work.  Your talent initiatives are adequate, but not best in class.  We recommend that you choose one or two high impact talent initiatives in the G3HC Best Practice Actionable Insights where you can become best in class. When you excel in targeted talent initiatives, your people will be more able to deliver results that matter to your company.";
                        if (range3)
        ...
        public (string, string, string) GetReport6Sentence(ScoresByTicker scores)
        {
            ...
            if (anyBelow5)
            {
                ...
                if (scores.TalentScore < 5)
                    below5.Add("<a href='#page-31' class='red'>G3HC Best Practice Actionable Insights 5 (Talent)</a>");
                if (scores.OrganizationScore < 5)
                    below5.Add("<a href='#page-35' class='red'>G3HC Best Practice Actionable Insights 6 (Organization)</a>");
                if (scores.LeadershipScore < 5)
                    below5.Add("<a href='#page-40' class='red'>G3HC Best Practice Actionable Insights 7 (Leadership)</a>");
                if (scores.HrScore < 5)
                    below5.Add("<a href='#page-43' class='red'>G3HC Best Practice Actionable Insights 8 (HR)</a>");
            ...
            } else
            {
                ...
                if(numGreaterThan8 >= 1 && numGreaterThan7 >= 2)
                {
                    return (
                        ...
                        "Based on your results; we recommend you review our G3HC Best Practice Actionable Insights.",
                        ""
                        );
                } 
                // Rule 2
